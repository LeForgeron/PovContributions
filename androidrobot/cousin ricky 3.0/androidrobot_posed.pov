/* androidrobot_posed.pov version 3.0
...
global_settings
{ assumed_gamma 1
 // With the eye lenses in the 3.0 version of this demo, the trace maxes
 // out at 160+, but there's no visual improvement at that level.
  max_trace_level 10
  #if (Rad)
    radiosity
    { count 100
