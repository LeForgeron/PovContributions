...
object
{
	GSprites_Hospital_Wall_Object(GSprites_North,GSprites_East,GSprites_South,GSprites_West,GSprites_Width,GSprites_Height)
	translate GSprites_Left_Vector*+3/2
...
object
{
	GSprites_Restaraunt_Wall_Object(GSprites_North,GSprites_East,GSprites_South,GSprites_West,GSprites_Width,GSprites_Height)
	translate GSprites_Left_Vector*+1/2
	translate GSprites_Up_Vector
}
...
object
{
	GSprites_Block_Wall_Object(GSprites_North,GSprites_East,GSprites_South,GSprites_West,GSprites_Width,GSprites_Height)
	translate GSprites_Left_Vector*-1/2
	translate GSprites_Up_Vector
}
...
object
{
	GSprites_Stone_Wall_Object(GSprites_North,GSprites_East,GSprites_South,GSprites_West,GSprites_Width,GSprites_Height)
	translate GSprites_Left_Vector*-3/2
	translate GSprites_Up_Vector
}
...
object
{
	GSprites_Fortress_Wall_Object(GSprites_North,GSprites_East,GSprites_South,GSprites_West,GSprites_Width,GSprites_Height/2)
	translate GSprites_Left_Vector*+3/2
}
