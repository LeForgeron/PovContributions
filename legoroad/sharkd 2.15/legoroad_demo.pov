...
#declare LRoad_StripeInterval =		array[3] { 64, 64, 64,}		// The distance between each stripe-interval.
...
#declare LRoad_DistanceUnit = 		10;				// The unit of distance equivalent to 1 foot. Used when determining super-elevation.
#declare LRoad_RoadColor =		color rgb <0.682353,0.682353,0.682353>;		// The principal color of the road surface.
#declare LRoad_EdgeColor =		color rgb <0.117647,0.627451,0.227451>;		// The shoulder color.
#declare LRoad_StrpColor =		color rgb 1;					// The stripe marker color.
...
object
{
	...
	(
		...
		array[5]		// The shape-specific parameters.						(array)
		{
			...
			0,			// The height of the ellipse. Generates a 'corkscrew' effect if not equal to zero.	(float)
...
object
{
	...
	(
		...
		array[6]		// The shape-specific parameters.							(array)
		{
			...
			0,			// The height of the spiral. Generates a 'corkscrew' effect if not equal to zero.	(float)
			...
			0,			// Reverse the spiral's direction?							(boolean)
		},
