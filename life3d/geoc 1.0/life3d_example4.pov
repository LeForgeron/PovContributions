...
// The glider 'returns' (the cell array wraps toroidally) to the center after about
// 55 generations
...
/////////////////////////////////////////////////////////////////////////////////////////////
#include "life3d.inc"
// declare the following variables/parameters (textures, etc) *after* calling 
// life3d.inc so that they will override the defaults 
/////////////////////////////////////////////////////////////////////////////////////////////
...
//                                          
/////////////////////////////////////////////////
// 2)     a file of cell values, Life3D_initialGenerationFile, needs to be specified in order to make the
//      first generation from a file. The file needs to be the same format as those saved by the
//      3dlife macro 'writeCells(filename)
...
//      be positive before computing the next generation). Default is 1 (centered)
//#declare Life3D_centerTheArray=1;
//
/////////////////////////////////////////////////////////////////////////////////////////////

/////////////////////////////////////////////////////////////////////////////////////////////
// The game of Life needs rules:
#declare myrules=array[4]{4,5,5,5}
...
#declare Life3D_Tiles=2;// 

/////////////////////////////////////////////////////////////////////////////////////////////
// Call the macro to generate this generation
...
// Life3D(xs,yS,zs,rules,gen1From,cellType,wrap,genNum)
//
