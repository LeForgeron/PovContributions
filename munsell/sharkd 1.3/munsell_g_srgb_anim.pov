...
#declare Muns_hue_adjust	= Muns_slice_angle * (4 + 2);
...
#declare Muns_text_cutout = cylinder {-y * 10.5/2, +y * 10.5/2, 26.5/2}
	...
	union
	{
		...
		difference
		{
			polygon
			{
				...
				translate	-x/2
				translate	-y/2
				scale		+x * 1500/1350 * 26.5
				scale		+y * 1500/1350 * 26.5
				rotate		+x * 90
