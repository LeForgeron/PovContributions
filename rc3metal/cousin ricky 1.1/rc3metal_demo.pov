 ...
 * 1.1   23-apr-2012  Version references are updated.
 */
...
#macro Html_open (s_Title)
  ...
  ( "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01//EN\">\n<html>\n<head>\n",
    ...
    "<title>RC3Metal 1.1 ", s_Title, " | POV-Ray Object Collection</title>\n",
    "</head>\n<body>\n<h1>RC3Metal 1.1 ", s_Title, "</h1>\n"
  )
#end
