 ...
 *        2015-May-30  Specularity of spheres is boosted a bit.
...
{ pigment
  { gradient -y color_map
    { [0 rgb <0.056, 0.111, 0.278> * OUTDOOR_BRIGHTNESS]
      [1 rgb <0.444, 0.556, 0.722> * OUTDOOR_BRIGHTNESS]
    }
  }
}
...
sphere
{ y, 1 scale 0.5
  RC3Metal (RC3M_C_CHROME, 0.95, 0.7)
  translate v_Floor_spot + <0, 0, -1>
}
