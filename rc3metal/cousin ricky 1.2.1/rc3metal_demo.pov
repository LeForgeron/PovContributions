/* rc3metal_demo.pov version 1.2.1
 ...
 * 1.1    2013-Apr-23  Version references are updated.
 *        2013-May-06  Gold HTML file shows pigment name at top.
 * 1.2    2013-Sep-06  Version references are updated.
 *        2014-Oct-15  Web page punctuation and alt texts are modified; DOCTYPE
 *                     is upgraded to HTML 5.
 * 1.2.1  2016-Mar-11  Specularity of color samples is increased.
 */
...
#macro Html_open (s_Title)
  ...
  ( "<!DOCTYPE html>\n<html>\n<head>\n<meta charset=\"UTF-8\">\n",
    ...
    "<title>RC3Metal 1.2.1 ", s_Title, " | POV-Ray Object Collection</title>\n",
    "</head>\n<body>\n<h1>RC3Metal 1.2.1 ", s_Title, "</h1>\n"
  )
#end

#macro Html_close()
  concat
  ( "<address>Copyright &copy; 2013 &ndash; 2016 Richard Callwood III.",
  ...
  #case (COLOR_SAMPLES)//-------------------------------------------------------
   ...
   //Render:
    ...
    { V_OBJ, 1
        ...
        RC3Metal (s_Colors [frame_number - 1], 2/3, 0.7)
      #end
    }
