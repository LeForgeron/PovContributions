...
#declare RWorld_Toggle_Area_Light		= true;
...
#declare RWorld_Shadow_Square_Width		= 1000*2;		// I had to fudge this due to the area light. Not sure why.
...
#declare RWorld_Corona_Radius			= RWorld_Ring_Radius*4;
...
{ 
	...
	material
	{
		...
		interior
		{
			media
			{
				scattering {1, RWorld_Light_Point_Color/2000}	// needs to be divided by RWorld_Corona_Radius doesn't it?
				density
				{
...
#if (RWorld_Toggle_Area_Light = true)
...
/*
	...
	light_source
	{
		...
		area_light
		RWorld_Sun_Diameter, RWorld_Sun_Diameter				// lights spread out across this distance (x * z)
