...
// ---------------
// AccompaniedHorses                 LevelCrossingWithoutBarrier           StaggeredJunction     
// Aircraft                          MenAtWork                             SteepHillDownwards    
// BendToLeft                        OpeningBridge                         SteepHillUpwards      
// BendToRight                       OverheadElectricCable                 TJunctionWithPriority 
// Cattle                            Pedestrians                           TrafficMergingFromLeft
// Crossroads                        Quayside                              TrafficQueues         
// CycleRoute                        RiskOfGrounding                       TrafficSignals        
// DoubleBendLeft                    RiskOfIce                             TramcarCrossing       
// DoubleBendRight                   RoadNarrowsBothSides                  TunnelAhead           
// DualCarriagewayEnds               RoadNarrowsOnLeft                     TwoWayTraffic         
// FallingRocks                      RoadNarrowsOnRight                    TwoWayTrafficCrossing 
// FrailPedestrians                  Roundabout                            UnevenRoad            
// HumpBridge                        SchoolCrossing                        WildAnimals           
// Humps                             Sidewinds                             WildHorses            
// JunctionOnBend                    SlipperyRoad                          ZebraCrossing         
// LevelCrossingWithBarrier          SoftVerges                   


// "Regulatory" Signs  (using prism objects defined in "roadsigns_uksymbols.inc")
// ------------------
// HeightLimit                       NoCycling                             NoTowedCaravans           
// MaxTruckLength                    NoExplosives                          NoUTurns                  
// MaxTruckWeight                    NoLeftTurn                            NoVehicles                
// NoBuses                           NoOvertaking                          PriorityToOncomingVehicles
// NoCarsOrBikes                     NoRightTurn                           WidthLimit                
                                                                           

// "Compulsory" Signs  (using prism objects defined in "roadsigns_uksymbols.inc")
// ------------------
// AheadOnly                         MiniRoundabout                        TurnLeftAhead    
// BusesAndCyclesOnly                PassEitherSide                        TurnRight        
// CyclesOnly                        SegregatedPedestrian                  TurnRightAhead   
// KeepLeft                          TramsOnly           
// KeepRight                         TurnLeft            


// Speed Limit Signs   (using objects generated on the fly)
// ----------------- 
