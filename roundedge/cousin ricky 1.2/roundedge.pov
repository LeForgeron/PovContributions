 ...
 * 1.1   09-jun-2012  Uploaded (faulty upload).
...
#switch (Test)
  ...
  #case (6)
    ...
    { object { Side }
      ...
      object { Edges texture { t_Metal_satin pigment { p_Sample } } }
  ...
  #case (26)
    ...
    { RE_Box_down (-ROUT, <ROUT, -RIN, ROUT>, 0.05, no)
      ...
      object
      { Join texture { t_Metal_satin pigment { rgb Vary [mod (Test+2, 6)] } }
      }
  ...
  #case (28)
    ...
    { RE_Cylinder (R*y, (ROUT - 4) * y, ROUT, R, no)
      ...
      object 
      { End_blob
        texture { t_Metal_satin pigment { rgb Vary [mod (Test+2, 6)] } }
      }
