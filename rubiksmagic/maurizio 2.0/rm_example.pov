...
object
{ RM_RubiksMagic("RULDLLDU")   // solved puzzle (planar configuration)
...
#declare RM_Partial=0.15;

object
{ RM_RubiksMagic("Rmp RmP Um Lm Dmp UmP Lm Dm")  // this is the "periscope" configuration, slightly deformed
  rotate 90*z
  translate RM_HalfThickness*y
...
object
{ RM_RubiksMagic("RmRmUmLmLmDvDmDv")     // "the cube"
  translate RM_HalfThickness*y
...
#declare RM_Decoration = RM_DecDogs;  // Decoration with dogs

object
{ RM_RubiksMagic("RRmRvURRvRmU")      // deformed starting rectangular configuration
  translate 0.5*RM_SizeDogs*<-3,1,-1>
  rotate 180*z
  rotate 25*y
  translate 0.5*RM_SizeDogs*y
  translate 3*RM_HalfThickness*y
  translate 1.5*RM_SizeDogs*<-1,0,-0.5>
}
