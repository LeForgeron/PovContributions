...
//#declare Orrery_StopDate			= Orrery_StartDate + clock * 365.25;		// Julian days, animation
...
#declare Orrery_Sun_Radius			= Orrery_SunRadius / Orrery_AU * Orrery_MeanRadiusMulti / 64;		// AU
...
#declare Orrery_Camera_Scale		= 1.75;
...
#switch (Orrery_Light_Mode)
	// old custom light array (very slow)
	// I need a new formula with better sphere packing, since right now the lights are concentrated near the poles
	#case (99)
		#local Orrery_Light_Area_Radius		= Orrery_Sun_Radius;
		#local Orrery_Light_Area_Theta_Num	= 6;
		#local Orrery_Light_Area_Theta_Dif	= 2 * pi/Orrery_Light_Area_Theta_Num;
		#local Orrery_Light_Area_Phi_Num	= 6;
		#local Orrery_Light_Area_Phi_Dif	= pi/Orrery_Light_Area_Phi_Num;
		#local Orrery_Light_Area_Lumens		= 2/Orrery_Light_Area_Theta_Num/Orrery_Light_Area_Phi_Num;
		#local Orrery_Light_Area_Temp		= Daylight(5800);
		#local Orrery_Light_Area_Color		= Light_Color(Orrery_Light_Area_Temp,Orrery_Light_Area_Lumens);
		...
		#end
	#break
	// new area light (less slow)
	#case (2)
		light_source
		{
			0
			Orrery_Light_Point_Color*2
			area_light
