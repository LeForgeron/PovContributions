/* spheresweep_lanes.pov version 1.0
 * Persistence of Vision Ray Tracer scene description file
 * POV-Ray Object Collection demo
 *
 * Demonstration of SphereSweep approximations and transparency.
 *
...
{ radial color_map { [0.5 rgb <0.9, 0, 0.03>] [0.5 rgb <1, 0.8, 0>] }
  frequency FREQ
  rotate 90 / FREQ * y
}
