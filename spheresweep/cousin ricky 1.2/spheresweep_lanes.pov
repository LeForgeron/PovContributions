/* spheresweep_lanes.pov version 1.2
...
#declare SDef = array[4][3]
{ { <0, 0>, <3.15, 7.6>, <-2.25, 3.0> },
  { <0, 2.1>, <-3.15, 7.1>, <0, -3.5> },
  { <0, 3.5>, <3.35, 2.1>, <0, -2.4> },
  { <2.55, -3.4>, <-3.35, 1.6>, <0, 0> },
}
#declare SPts = SSwp_Bezier (SDef, "-", 2, 2)
...
#declare Letters[4] = SphereSweep_Merge (SSWP_BEZIER_SPLINE, SPts, NeonRs, RES)
