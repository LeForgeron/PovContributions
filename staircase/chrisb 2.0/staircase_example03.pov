...
/**********************************************************************************/
/* staircase_example03.pov  -  Created by Chris Bartlett April 2006               */
/*                                                                                */
...
//camera {location <-30,10,5> look_at  <0,4.0,7>}
camera {location <-7.4,4.7,-8.3> look_at  <0,7.0,7>}       // View looking across lobby
//camera {location <-6.4,4.7,7.4> look_at  <0,4.8,4.8>}    // Staircase camera
...
//light_source {<-5,CeilingHeight-0.2,-3> color rgb 1}
